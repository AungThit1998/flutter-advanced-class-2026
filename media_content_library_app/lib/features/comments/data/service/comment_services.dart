...
import 'package:media_content_library_app/features/comments/data/models/edit_delete_comment_response.dart';
...
class CommentServices {
  ...
  Future<EditDeleteCommentResponse> editComment({
    required String text,
    required String type,
    required String id,
    ...
    if (token?.isNotEmpty == true) {
      ...
      return EditDeleteCommentResponse.fromJson(response.data);
    } else {
      throw Exception("User Not Logged in");
    }
  }

  Future<EditDeleteCommentResponse> deleteComment({
    required String type,
    required String id,
    required String commentId,
  }) async {
